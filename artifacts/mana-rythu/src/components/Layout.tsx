...
import {
  Home, ShoppingBag, Sprout, LayoutDashboard, Settings,
  Bell, Search, LogOut, Menu, X, ChevronRight, Shield,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/farmer", label: "My Crops", icon: Sprout },
      ...
      >
        ...
        <div className="border-t border-sidebar-border p-3 shrink-0">
          {user ? (
            ...
            <Link href="/login" className="block text-sm text-center text-primary font-medium py-2 hover:underline">
              Sign in
            </Link>
          )}
        </div>
