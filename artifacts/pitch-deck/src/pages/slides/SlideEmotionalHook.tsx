  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative font-display" style={{ background: "#052e16" }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-[10vw]">
        <div
          className="w-[3px] mb-[4vh]"
          style={{ height: "6vh", background: "linear-gradient(to bottom, transparent, #22c55e)" }}
        />

        <h2
          className="font-display font-extrabold text-white text-center"
          style={{ fontSize: "4.6vw", lineHeight: 1.15, maxWidth: "72vw" }}
        >
        ...
        <div
          className="w-[3px] mt-[4vh] mb-[7vh]"
          style={{ height: "6vh", background: "linear-gradient(to bottom, #22c55e, transparent)" }}
        />

        {/* Visual flow: Farmer → Middlemen → Buyer */}
        <div className="flex items-center gap-[0vw] w-full max-w-[76vw]">

          {/* Farmer */}
          <div className="flex flex-col items-center" style={{ flex: 1 }}>
            <div
              className="rounded-2xl flex flex-col items-center justify-center py-[3.5vh] px-[2vw]"
              style={{ background: "rgba(34,197,94,0.15)", border: "2px solid #22c55e", width: "100%" }}
            >
              <svg viewBox="0 0 60 60" fill="none" style={{ width: "4.5vw", height: "4.5vw" }}>
                ...
                <path d="M18 30 C22 24 38 24 42 30" stroke="#4ade80" strokeWidth="2" strokeLinecap="round" fill="none" />
                {/* Hat brim */}
          ...
          <div className="flex flex-col items-center" style={{ flex: 1.4 }}>
            <div
              className="rounded-2xl flex flex-col items-center justify-center py-[3.5vh] px-[2vw]"
              style={{ background: "rgba(220,38,38,0.15)", border: "2px solid #dc2626", width: "100%" }}
            >
              <svg viewBox="0 0 60 60" fill="none" style={{ width: "4.5vw", height: "4.5vw" }}>
          ...
          <div className="flex flex-col items-center" style={{ flex: 1 }}>
            <div
              className="rounded-2xl flex flex-col items-center justify-center py-[3.5vh] px-[2vw]"
              style={{ background: "rgba(255,255,255,0.08)", border: "1.5px solid rgba(255,255,255,0.2)", width: "100%" }}
            >
              <svg viewBox="0 0 60 60" fill="none" style={{ width: "4.5vw", height: "4.5vw" }}>
        ...
        <p className="font-display font-semibold mt-[4.5vh]" style={{ fontSize: "1.7vw", color: "rgba(255,255,255,0.45)" }}>
          The farmer grows the food. The middlemen take the profit. <span style={{ color: "#4ade80" }}>Mana Rythu fixes this.</span>
        </p>
      </div>
