    ...
    <div className="w-screen h-screen overflow-hidden relative font-display" style={{ background: "#052e16" }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-[7vw]">
        ...
        <div className="text-center mb-[5vh]">
          <p className="font-display font-semibold mb-[1vh]" style={{ fontSize: "1.3vw", color: "#4ade80", textTransform: "uppercase", letterSpacing: "0.2em" }}>Market Size</p>
        ...
        <div className="flex items-end gap-[3vw] w-full" style={{ maxWidth: "86vw" }}>
          ...
          <div className="flex flex-col items-center" style={{ flex: 1 }}>
            <div className="rounded-2xl w-full flex flex-col items-center justify-end pt-[3vh] pb-[3.5vh] px-[2vw]" style={{ background: "rgba(255,255,255,0.06)", border: "1.5px solid rgba(255,255,255,0.1)", height: "38vh" }}>
              <p className="font-display font-extrabold text-center" style={{ fontSize: "7vw", lineHeight: 1, color: "#4ade80" }}>₹30T</p>
              <p className="font-display font-bold text-white text-center mt-[1.5vh]" style={{ fontSize: "2vw", lineHeight: 1.2 }}>Agri Supply Chain</p>
              <p className="font-display font-normal text-center mt-[1vh]" style={{ fontSize: "1.25vw", color: "rgba(255,255,255,0.5)", lineHeight: 1.4 }}>India's total agricultural supply chain value (Ministry of Agriculture)</p>
            </div>
          </div>

          <div className="flex flex-col items-center" style={{ flex: 1 }}>
            <div className="rounded-2xl w-full flex flex-col items-center justify-end pt-[3vh] pb-[3.5vh] px-[2vw]" style={{ background: "rgba(34,197,94,0.15)", border: "2px solid #22c55e", height: "50vh" }}>
              <p className="font-display font-extrabold text-center" style={{ fontSize: "7vw", lineHeight: 1, color: "#4ade80" }}>140M</p>
              <p className="font-display font-bold text-white text-center mt-[1.5vh]" style={{ fontSize: "2vw", lineHeight: 1.2 }}>Farm Holdings</p>
              <p className="font-display font-normal text-center mt-[1vh]" style={{ fontSize: "1.25vw", color: "rgba(255,255,255,0.5)", lineHeight: 1.4 }}>India's farm holdings per NSSO census — our addressable grower base</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center" style={{ flex: 1 }}>
            <div className="rounded-2xl w-full flex flex-col items-center justify-end pt-[3vh] pb-[3.5vh] px-[2vw]" style={{ background: "rgba(255,255,255,0.06)", border: "1.5px solid rgba(255,255,255,0.1)", height: "30vh" }}>
              <p className="font-display font-extrabold text-center" style={{ fontSize: "7vw", lineHeight: 1, color: "#4ade80" }}>350M</p>
              ...
              <p className="font-display font-normal text-center mt-[1vh]" style={{ fontSize: "1.25vw", color: "rgba(255,255,255,0.5)", lineHeight: 1.4 }}>Online rural population ready for digital agriculture (TRAI 2024)</p>
            </div>
          </div>

        </div>

        <p className="font-display font-semibold mt-[3.5vh]" style={{ fontSize: "1.5vw", color: "rgba(255,255,255,0.4)" }}>
          Starting in Telangana &amp; AP — scaling across South India
        </p>
