export default function SlideWhyNow() {
  const reasons = [
    {
      label: "Rural Smartphone Adoption",
      detail: "India now has 700M+ internet users. Rural connectivity is at an all-time high.",
      color: "#16a34a",
      icon: (
    ...
    {
      label: "Digital Payments Growth",
      detail: "UPI now processes billions of transactions monthly — even in rural Telangana & AP.",
      color: "#0891b2",
      icon: (
        <svg viewBox="0 0 56 56" fill="none" style={{ width: "4vw", height: "4vw" }}>
    ...
    {
      label: "AI Now Speaks Local Languages",
      detail: "GPT-4o supports Telugu, Hindi, and 90+ languages. AI guidance is no longer just for English speakers.",
      color: "#7c3aed",
      icon: (
        <svg viewBox="0 0 56 56" fill="none" style={{ width: "4vw", height: "4vw" }}>
    ...
    {
      label: "Government Push for Digital Agriculture",
      ...
      icon: (
        <svg viewBox="0 0 56 56" fill="none" style={{ width: "4vw", height: "4vw" }}>
          ...
          <rect x="20" y="32" width="16" height="16" rx="1" fill="white" opacity="0.2" />
          <rect x="20" y="32" width="16" height="16" rx="1" stroke="white" strokeWidth="2" />
  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative font-display" style={{ background: "#052e16" }}>
      ...
      <div className="absolute bottom-[3vh] right-[3vw]">
        <span className="font-display font-semibold" style={{ fontSize: "1.4vw", color: "rgba(255,255,255,0.18)" }}>03</span>
      </div>
    </div>
  );
}
