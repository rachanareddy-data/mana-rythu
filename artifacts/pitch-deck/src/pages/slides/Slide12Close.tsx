  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative font-display" style={{ background: "#052e16" }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-[10vw]">
        ...
        <svg viewBox="0 0 100 100" fill="none" style={{ width: "5.5vw", height: "5.5vw", marginBottom: "3.5vh" }}>
        ...
        <div style={{ width: "7vw", height: "2px", background: "rgba(34,197,94,0.3)", margin: "3vh 0" }} />

        <p className="font-display font-semibold text-center" style={{ fontSize: "1.75vw", color: "rgba(255,255,255,0.55)", maxWidth: "60vw", lineHeight: 1.5 }}>
          Mana Rythu is building the operating system for Indian agriculture.
        </p>

        <p className="font-display font-extrabold text-center mt-[1.5vh]" style={{ fontSize: "2.2vw", color: "#4ade80", letterSpacing: "0.04em" }}>
        ...
        <div className="text-center mt-[3.5vh]">
          ...
          <p className="font-display font-normal mt-[0.6vh]" style={{ fontSize: "1.5vw", color: "rgba(255,255,255,0.4)" }}>M.S. Data Science · Saint Peter's University</p>
        </div>

        <div className="flex items-center gap-[4vw] mt-[3.5vh]">
          <div className="flex items-center gap-[0.8vw]">
            ...
            <p className="font-display font-semibold" style={{ fontSize: "1.45vw", color: "rgba(255,255,255,0.45)" }}>@mana.rythu</p>
          </div>
          ...
          <div className="flex items-center gap-[0.8vw]">
            ...
            <p className="font-display font-semibold" style={{ fontSize: "1.45vw", color: "rgba(255,255,255,0.45)" }}>mana-rythu.replit.app</p>
          </div>
        </div>
